export const defaultFontProfileConfig = {
    font: {
        body: {
            family: "Inter",
            size: "1.0rem"
...
export function applyFontProfileDefaults(config) {
    return {
        font: {
            body: {
            ...
            heading: {
                family: config?.font?.heading?.family ?? defaultFontProfileConfig.font.heading.family,
                scale: {
            ...
            lineHeight: config?.font?.lineHeight ?? defaultFontProfileConfig.font.lineHeight,
            tableHeader: {
                weight: config?.font?.tableHeader?.weight ??
                    defaultFontProfileConfig.font.tableHeader.weight
            }
        }
    };
}
//# sourceMappingURL=font-profile-schema.js.map